...
As target frames go up by 1, accuracy increases with 0.11480, meaning that if target was shown for 6 frames, accuracy would be 0.11*6 = 0.66
Also, we see that there is a significant interaction between subjective reporting of visibility of the target and accuracy: The higher pas rating the more accurate the answer. This can be assessed from both the interaction plot, but also from the model.
