...
x = np.arange(0, 6, 0.1) # all values from 0-6 which goes up by 0.1 each time
x
y = squareFunction(3)

np.random.seed(7)
y_noise = np.random.normal(scale=5) # loc = mean, scale = std deviation, size = numbers
len(y_noisy)

noise_vector = y + y_noisy
