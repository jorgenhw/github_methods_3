...
y = np.arange(0, 6, 0.1) # all values from 0-6 which goes up by 0.1 each time
f(x) = squareFunction(i)

np.random.seed(7)
y_noise = np.random.normal(scale=5, size = len(x)) # loc = mean, scale = std deviation, size = numbers

noise_vector = y + y_noise

# Plot libraries
import pandas as pd
from matplotlib import pyplot as plt

# Plot syntax matplotlib
